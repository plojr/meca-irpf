...
<title>Adicionar Desdobramento</title>
<style>
th, td {
	text-align: center
}
		...
		<div class="col py-3">
			<form action="adicionar_desdobramento" method="post">
				...
				<div class="form-group">
					...
					<input type="number" min="0.1" step="0.1" id="proporcao_id" name="proporcao" class="form-control" required
						   placeholder="Digite a proporção do desmembramento. Exemplo: se o desdobramento for de 1:10, então digite 10" />
				</div>
				<br />
